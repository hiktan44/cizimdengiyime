...
export const LandingPage: React.FC<LandingPageProps> = (props) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-400 via-green-500 via-blue-500 to-indigo-600 relative overflow-hidden">
      {/* Animated gradient overlay for extra depth */}
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-green-500/10 via-blue-500/10 to-indigo-500/10 animate-pulse pointer-events-none z-0"></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className={`${cardBg} rounded-2xl p-8 border ${theme === 'dark' ? 'border-slate-700 hover:border-cyan-500' : 'border-slate-200 hover:border-cyan-400'} transition-all duration-300 shadow-lg group`}>
              ...
              <p className={`${descriptionTextClass} leading-relaxed mb-4`}>
                {t.howItWorks.useCases.feature1.desc}
              </p>
              <ul className={`${descriptionTextClass} text-sm space-y-2`}>
            ...
            {/* 6. Fotomatik */}
            <div className={`${cardBg} rounded-2xl p-8 border ${theme === 'dark' ? 'border-slate-700 hover:border-teal-500' : 'border-slate-200 hover:border-teal-400'} transition-all duration-300 shadow-lg group`}>
              <div className="w-16 h-16 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`${cardBg} rounded-2xl p-8 border ${theme === 'dark' ? 'border-slate-700 hover:border-indigo-500' : 'border-slate-200 hover:border-indigo-400'} transition-all duration-300 shadow-lg group`}>
              <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
