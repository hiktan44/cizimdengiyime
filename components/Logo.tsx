    ...
    return (
        <div className={`flex items-center gap-3 ${className}`}>
            ...
            <div className="flex flex-col justify-center leading-tight">
                <span className="text-xl md:text-3xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-orange-400">
                    FASHEONE
                </span>
                <span className={`text-[0.5rem] md:text-[0.8rem] font-bold tracking-[0.2em] uppercase ${theme === 'light' ? 'text-[#1e40af]' : 'text-slate-300 opacity-90'}`}>
                    Sketch to Reality
                </span>
            </div>
        </div>
