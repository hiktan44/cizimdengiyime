...
export const DownloadIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M12 9.75v10.32m0-10.32-2.83 2.829M12 9.75l2.83 2.829M12 1.5v10.32" />
    </svg>
);
...
export const ArrowsPointingOutIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9.75 9.75M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9.75 14.25M14.25 9.75 20.25 3.75m0 0h-4.5m4.5 0v4.5M14.25 14.25 20.25 20.25m0 0h-4.5m0 4.5v-4.5" />
    </svg>
);
...
export const FlipHorizontalIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 13.5V2.25m12 5.25h2.25a2.25 2.25 0 0 1 2.25 2.25v13.5a2.25 2.25 0 0 1-2.25 2.25H3.75a2.25 2.25 0 0 1-2.25-2.25V9.75A2.25 2.25 0 0 1 3.75 7.5H6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 12h-6m6 0-3 3m3-3-3-3M5 12h6m-6 0 3-3m-3 3 3 3" />
    </svg>
);

export const FlipVerticalIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
         <path strokeLinecap="round" strokeLinejoin="round" d="M12 5v14m0 0 3-3m-3 3-3-3M12 5l3 3m-3-3-3 3" />
    </svg>
);

export const ScaleUpIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9.75 9.75M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9.75 14.25M14.25 9.75 20.25 3.75m0 0h-4.5m4.5 0v4.5M14.25 14.25 20.25 20.25m0 0h-4.5m0 4.5v-4.5" />
    </svg>
);
