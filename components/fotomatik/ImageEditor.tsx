                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <button 
                        ...
                        className={`py-3 px-2 rounded-xl flex flex-col items-center justify-center gap-1 transition-colors text-xs ${
                           config.flipHorizontal ? 'bg-blue-600 text-white' : 'bg-slate-700 hover:bg-slate-600 text-slate-200'
                        }`}
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button 
                        ...
                        className={`py-3 px-2 rounded-xl flex flex-col items-center justify-center gap-1 transition-colors text-xs ${
                           config.flipVertical ? 'bg-blue-600 text-white' : 'bg-slate-700 hover:bg-slate-600 text-slate-200'
                        }`}
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`py-2 px-3 text-sm rounded-lg border transition-all ${
                            !isCustomMode && config.cropRatio === ratio.value
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button 
                        ...
                        title={aspectLock ? "Oranı Kilitle" : "Kilidi Aç"}
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          {aspectLock ? (
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs text-slate-500 mb-1.5">Genişlik</label>
                        <input 
                          type="number" 
                          value={currentWidth}
                      ...
                      <div>
                        <label className="block text-xs text-slate-500 mb-1.5">Yükseklik</label>
                        <input 
                          type="number" 
                          value={currentHeight}
                    ...
                    {config.resize && (
                      ...
                      >
                        Sıfırla ({naturalDims.width} x {naturalDims.height})
                      </button>
                    )}
                  </div>
                </div>
              ...
              {activeTab === 'adjust' && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                  ...
                  >
                    ...
                    {isEnhancing ? 'Analiz Ediliyor...' : 'Otomatik İyileştir (AI)'}
                  </button>
