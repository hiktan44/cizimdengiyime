  ...
  return (
    <div className="fixed bottom-4 right-4 z-[120] sm:bottom-6 sm:right-6">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group flex items-center gap-0 sm:gap-3 rounded-full sm:rounded-2xl border border-emerald-200/70 bg-white/95 p-2 sm:px-4 sm:py-3 shadow-xl shadow-emerald-500/20 backdrop-blur transition hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-emerald-500/30"
